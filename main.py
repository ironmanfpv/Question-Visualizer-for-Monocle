...
def main():
    ...
    note_group = []
    for slide in data:
        slide_number = slide['Number']                # Change 'Number' to 'slideNumber' to work with Teleprompter
        notes = slide['Question']                     # Change 'Question' to 'notes' to work with Teleprompter
        if slide_number == index:
            ...
            return {
                "Number": slide_number,                # Change 'Number' to 'slideNumber' to work with Teleprompter
                "Question": notes                      # Change 'Question' to 'notes' to work with Teleprompter
            }
